...
namespace Caminho_minimo
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Vertice origem = g.get_vertice("1");
            Vertice vertice_alvo = g.get_vertice("6");
            ...
            g.inserir_aresta("2", "4", 3);
            g.inserir_aresta("2", "5", 4);
            g.inserir_aresta("3", "4", 2);
            g.inserir_aresta("3", "5", 6);
            g.inserir_aresta("4", "6", 7);
            g.inserir_aresta("5", "6", 8);

            caminho = new ArrayList();
            origem = g.get_vertice("1");
            vertice_alvo = g.get_vertice("6");

            Console.WriteLine("Testando grafo");
            Dijkstra(g, origem);
